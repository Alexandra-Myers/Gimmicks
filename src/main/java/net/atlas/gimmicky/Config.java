...
public class Config {
    ...
    public static String[] tools = new String[] { "wooden_sword", "wooden_axe", "wooden_pickaxe", "wooden_shovel", "wooden_hoe",
        "stone_sword", "stone_axe", "stone_pickaxe", "stone_shovel", "stone_hoe",
        "golden_sword", "golden_axe", "golden_pickaxe", "golden_shovel", "golden_hoe",
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        tools = Arrays.stream(configuration.getStringList(
            "tools",
            Configuration.CATEGORY_GENERAL,
            tools,
            "Tools obtainable from certain gimmicks...")).filter(Item.itemRegistry::containsKey).toArray(String[]::new);
